    ...
    return (
        <>
            <header className="h-[var(--header-height)] px-4 md:px-6 flex items-center justify-between glass-panel mx-2 md:mx-4 mt-2 md:mt-4 mb-2 z-50 transition-all duration-300">
                <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <button
                        ...
                        className="text-lg md:text-xl font-semibold text-white/70 hover:text-white hover:bg-white/10 px-3 py-1 rounded-lg transition-colors"
                    >
                ...
                {/* Date Navigation */}
                <div className="flex items-center gap-3 md:gap-4 bg-black/20 p-1.5 rounded-xl border border-white/5">
                    <button
                        onClick={onPrev}
            ...
            <YearPicker
                ...
                currentYear={parseInt(format(currentDate, 'yyyy'))}
